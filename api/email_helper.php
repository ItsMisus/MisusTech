 ...
 * FIX #7: $mail inizializzata a null prima del try-block,
 *          catch usa instanceof per evitare "Undefined variable"
 */
...
class EmailHelper {
    ...
    private static function getMailer() {
        // FIX #7: $mail inizializzata prima del try per essere visibile nel catch
    ...
    public static function sendWelcomeEmail($userEmail, $userName) {
        // FIX #7: $mail inizializzata a null fuori dal try
        $mail = null;
        try {
            $mail = self::getMailer();
...
<body>
    <div class='container'>
        <div class='header'><h1>MIRA</h1></div>
        <div class='content'>
            ...
            <center><a href='{$siteUrl}' class='button'>Visita il Negozio</a></center>
            <p style='margin-top: 30px; color: #999; font-size: 13px;'>Cordiali saluti,<br><strong>Team MIRA</strong></p>
        </div>
        <div class='footer'>
...
<body>
    <div class='container'>
        <div class='header'><h1>Nuovo Messaggio - MIRA</h1></div>
        <div class='content'>
            <div class='info-section'>
                <h3 style='margin-top: 0;'>Informazioni Mittente</h3>
                <div class='info-row'><span class='label'>Nome:</span> {$contactData['first_name']} {$contactData['last_name']}</div>
                ...
                <div class='info-row'><span class='label'>IP:</span> {$contactData['ip']}</div>
            </div>
